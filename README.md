...
|                         | 3. Make selection of using either GPS or enter a postal code.                                                                                                             | If postal code is selected, an input and submit will appear for the user to enter a postal code. Once switched to GPS, the input box will disappear. Subsequently. your GPS or postal code location will appear as a marker on the map |
